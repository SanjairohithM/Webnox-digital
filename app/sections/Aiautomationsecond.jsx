...
export default function WebnoxDigitalSection() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      layerTl
        .to([layer1Ref.current, layer2Ref.current], {
          visibility: "visible",
          opacity: 1,
          scale: 1,
          duration: 0.3,
        ...
        >
          <div className="relative min-h-[400px] w-full max-w-4xl">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/4 z-10">
              ...
              <div className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-4/5 h-2 bg-gradient-to-r from-transparent via-blue-400/30 to-transparent rounded-full blur-sm"></div>
            </div>

              {/* Layer 3 - Second from bottom (no gap with layer 4) */}
              <div ref={layer3Ref} className="absolute top-0 left-0 w-full z-30">
                <Image
                  src="/aiauto.svg"
                ...
                />
                {/* Subtle shadow like reference image */}
                <div className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-4/5 h-2 bg-gradient-to-r from-transparent via-cyan-400/30 to-transparent rounded-full blur-sm"></div>
              </div>

      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: Target, title: "UK Markets", desc: "Finance, e-commerce, technology, services" },
              { icon: Globe, title: "Culturally Aligned", desc: "Strategies tailored to British audiences" },
              { icon: TrendingUp, title: "Measurable Impact", desc: "Trusted by UK businesses with growth results" }
            ].map((item, index) => (
              <div
                key={index}
...
const RotatingWhyChooseSection = () => {
  ...
  const features = [
    { icon: Target, title: "Expertise in UK markets", desc: "Finance, e-commerce, technology, services." },
    { icon: Globe, title: "Culturally aligned branding", desc: "Strategies tailored to British audiences." },
    { icon: Building2, title: "Enterprise-focused", desc: "Scalable solutions for growing organisations." },
    { icon: Shield, title: "Compliance-conscious", desc: "GDPR-friendly digital brand rollouts." },
    { icon: Handshake, title: "Trusted by UK businesses", desc: "With measurable growth impact." }
  ]
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        >
          Why Choose Our Branding Services in the UK?
        </h2>
  ...
  const services = [
    {
      ...
      description: "Positioning your business in the competitive UK landscape.",
      image: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=500&h=300&fit=crop&crop=center"
    },
    {
      icon: Palette,
      title: "Visual Identity Design",
      description: "Creative assets that resonate with British audiences.",
    ...
    },
    {
      ...
      description: "Ensure brand consistency across all UK branches.",
      image: "https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=500&h=300&fit=crop&crop=center"
    },
    {
      icon: Monitor,
      title: "Digital Branding",
      description: "Optimised for UK digital channels, from websites to social media.",
      image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=500&h=300&fit=crop&crop=center"
    },
    {
      icon: RefreshCcw,
      title: "Rebranding Services",
      description: "Helping UK businesses modernise and re-launch successfully.",
...
// Interactive UK Coverage Section
const InteractiveUKCoverageSection = () => {
  const sectionRef = useRef(null)
  const titleRef = useRef(null)
  const descRef = useRef(null)
  const cardsRef = useRef([])
  ...
  const cities = [
    { icon: Building2, name: "London", desc: "Corporate Hub", projects: "500+", color: "from-blue-500 to-blue-600" },
    { icon: Factory, name: "Manchester", desc: "Startup Center", projects: "300+", color: "from-purple-500 to-purple-600" },
    { icon: Briefcase, name: "Birmingham", desc: "Business Hub", projects: "250+", color: "from-green-500 to-green-600" },
    { icon: Users, name: "Leeds", desc: "Innovation Hub", projects: "200+", color: "from-orange-500 to-orange-600" }
  ]
  ...
  return (
    ...
    >
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        >
          We partner with organisations nationwide, from London corporates to Manchester startups, delivering branding that connects.
        </p>
        ...
        <div className="mt-16">
          <div className="inline-flex items-center bg-gradient-to-r from-[#00B9FF] to-[#0097D9] rounded-full px-8 py-4 shadow-2xl">
            ...
            <span className="text-white font-bold text-lg">+50 Cities Nationwide</span>
          </div>
        </div>
      </div>
    </section>

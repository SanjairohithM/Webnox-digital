        ...
        <div className="w-full px-6 lg:px-20">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto flex-shrink-0">
                <a
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-[#3FD7F1] to-[#25C3E5] text-white font-semibold rounded-lg hover:opacity-90 transition-opacity whitespace-nowrap text-base md:text-lg text-center"
                >
                  Book a Meeting
                </a>
              </div>
          ...
          <div className="py-12 grid grid-cols-1 md:grid-cols-5 gap-12">
            ...
            <div className="md:col-span-3 space-y-6">
              <nav className="flex flex-wrap gap-x-5 md:gap-x-6 lg:gap-x-7 gap-y-4 text-base md:text-lg relative">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-3 text-sm md:text-base mt-0">
                ...
                <div>
                  <h5 className="font-semibold text-gray-800 mb-2 uppercase tracking-wide">Contact</h5>
              ...
              <div className="mb-4">
                <Link href="/" className="flex items-center cursor-pointer hover:scale-105 transition-transform duration-300">
                  <Image
                    ...
                    width={200}
                    height={200}
                    className="object-contain w-40 h-40 md:w-48 md:h-48 lg:w-[200px] lg:h-[200px]"
                  />
                </Link>
              </div>
